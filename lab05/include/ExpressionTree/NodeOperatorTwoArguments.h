...
private:
    ...
    NodeOperatorTwoArguments(NodeOperatorTwoArguments&& other) noexcept;
...
template<typename T>
NodeOperatorTwoArguments<T>::NodeOperatorTwoArguments(NodeOperatorTwoArguments&& other) noexcept
{
    std::cout << "move constructor"<< operatation << std::endl;
